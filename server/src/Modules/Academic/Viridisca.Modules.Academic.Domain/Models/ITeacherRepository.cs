...
namespace Viridisca.Modules.Academic.Domain.Models
{
    public interface ITeacherRepository
    {
        ...
        /// <summary>
        /// Explicitly tracks a newly-created TeacherSubject as Added. Adding it only via
        /// teacher.AddSubject(...) on an already-tracked Teacher isn't picked up as an insert
        /// by EF's change tracker here — it gets treated as a modify-existing-row update
        /// (0 rows affected -> DbUpdateConcurrencyException). Same fix as
        /// IUserRepository.AddRefreshToken in the Identity module.
        /// </summary>

...
public class UserRole : Entity
{
    ...
    /// <summary>
    /// Activates (or reactivates) this role assignment
    /// </summary>
    public Result Activate()
    {
        if (IsActive)
        {
            return Result.Failure(Error.Failure("UserRole.AlreadyActive", "User role is already active"));
        }
    ...
    /// <summary>
    /// Deactivates (revokes) this role assignment
    /// </summary>
    public Result Deactivate()
    {
        if (!IsActive)
        {
            return Result.Failure(Error.Failure("UserRole.AlreadyInactive", "User role is already inactive"));
        }
